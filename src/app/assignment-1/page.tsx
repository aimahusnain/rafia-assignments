      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="bg-white shadow-lg rounded-lg mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center p-6">
            <h1 className="text-3xl font-bold text-indigo-600 mb-4 md:mb-0">Layout</h1>
            <nav>
        ...
        <footer className="mt-12 bg-white shadow-lg rounded-lg">
          <div className="container mx-auto px-6 py-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-600 mb-4 md:mb-0">&copy; 2024 Layout. All rights reserved.</div>
